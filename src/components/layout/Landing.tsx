...
const Landing = () => {
  return (
    <section className="mb-40 overflow-hidden" id="home">
      <div className="relative overflow-hidden bg-cover bg-no-repeat bg-[50%] h-[500px] background-radial-gradient">
          <div className="flex h-full items-center justify-center">
            <div className="px-6 text-center text-white md:px-12">
              ...
              <p className="text-3xl mb-6 font-semibold md:text-4xl, xl:text-5xl">I am a full-stack web developer.</p>
              <a
